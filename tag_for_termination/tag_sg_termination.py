...
def set_attached_sgs_compliance_and_tag(sgs_attached_to_lambda, sg_ids_attached_to_network, time_stamp, result_token):
...
def set_unattached_sgs_non_compliance_and_tag(all_sg_ids, sgs_attached_to_lambda, time_stamp, result_token):
...
def lambda_handler(event, context):
    try:        
        ...
        """Set Compliance"""
        set_attached_sgs_compliance_and_tag(sgs_attached_to_lambda, sg_ids_attached_to_network, time_stamp, result_token)

        set_unattached_sgs_non_compliance_and_tag(all_sg_ids, sgs_attached_to_lambda, time_stamp, result_token)
